...
import { Accessoriesapicaller } from '../Api/AccesoriesApi';// Import the apicaller function
const AccesoriesPage = () => {
  ...
  useEffect(() => {
    ...
    const getProducts = async () => {
      try {
        const data = await Accessoriesapicaller(); // Call the apicaller to fetch products
